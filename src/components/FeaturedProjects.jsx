    ...
    return (
        <div className="font-['kadwa']">
            ...
            <div className="flex justify-center items-center flex-wrap lg:flex-nowrap mx-4 md:mx-20 lg:mx-10 "> {items.map(({ title, desc, techStack, liveLink, github, img }, index) => (
                <div key={index} className="py-5 px-4 bg-gray-200 m-2 gap-2 rounded-xl hover:ring-8 flex flex-col">
                    <img src={img} className="h-50 md:h-60 lg:h-100 rounded-xl " />
                    <p className="font-bold text-xl my-2 inline-block">{title}</p>
